function plot_variable_full(ELIST,NLIST,beso,Variable,x,y,z)
...
colormap(jet)
hold on
patch('Faces',ELIST_simp(find(plot_aux_densities),[1:4]),'Vertices',NLIST_simp(:,[1,3,2]),'FaceVertexCData',Variable,'FaceColor','flat','Linestyle','none')
patch('Faces',ELIST_simp(find(plot_aux_densities),[5:8]),'Vertices',NLIST_simp(:,[1,3,2]),'FaceVertexCData',Variable,'FaceColor','flat','Linestyle','none')
patch('Faces',ELIST_simp(find(plot_aux_densities),[1,2,6,5]),'Vertices',NLIST_simp(:,[1,3,2]),'FaceVertexCData',Variable,'FaceColor','flat','Linestyle','none')
patch('Faces',ELIST_simp(find(plot_aux_densities),[3,4,8,7]),'Vertices',NLIST_simp(:,[1,3,2]),'FaceVertexCData',Variable,'FaceColor','flat','Linestyle','none')
patch('Faces',ELIST_simp(find(plot_aux_densities),[1,4,8,5]),'Vertices',NLIST_simp(:,[1,3,2]),'FaceVertexCData',Variable,'FaceColor','flat','Linestyle','none')
patch('Faces',ELIST_simp(find(plot_aux_densities),[2,3,7,6]),'Vertices',NLIST_simp(:,[1,3,2]),'FaceVertexCData',Variable,'FaceColor','flat','Linestyle','none')
